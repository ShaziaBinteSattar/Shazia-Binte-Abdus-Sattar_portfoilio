...
function Portfolio() {
  return (
    <>
      <section id="portfolio" className="w-full py-36 px-8 text-center bg-[#b5a2b2]">
        <h4 className={`${caveat.className} text-white text-4xl lg:text-5xl`}>
          <span className="text-[#b15d9f]">M</span>y{" "}
          <span className="text-[#b15d9f]">L</span>ast{" "}
          <span className="text-[#b15d9f]">W</span>ork
        </h4>
