     ...
     <section id="testimonials" className="bg-[#0a0908] py-40 px-4 md:px-8">
      <div className="text-white text-center">
        <h4 className="text-white text-4xl lg:text-5xl font-[Caveat] ">
          <span>
            <span className="text-[#b15d9f]">W</span>hat{' '}
            <span className="text-[#b15d9f]">O</span>ther{' '}
            <span className="text-[#b15d9f]">P</span>eople{' '}
            <span className="text-[#b15d9f]">S</span>ay
          </span>
        </h4>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="mx-auto py-8 px-2 md:px-4 border-t-[3px] border-solid border-light-beige rounded-2xl select-none bg-[#676566] cursor-grab flex flex-col justify-center items-center"
              >
                <div className="w-[8rem] border-[3px] border-solid border-text-[#b15d9f] rounded-full p-1">
                  <Image
                    src={person.src}
                    alt={person.alt}
                    width={128}
                ...
                <p className="my-4 text-[#f75ee2]">{person.role}</p>
