      ...
      <section id="services" className="py-40 px-2 md:px-8 bg-[#1a1a1a]">
        <div className="text-center">
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-4 text-start">
            ...
            <div className="rounded-xl py-6 px-4 bg-[#9c6c8b] flex flex-col justify-between items-center cursor-pointer transition-all duration-[1.2s] hover:bg-[#444]">
            ...
            <div className="rounded-xl py-6 px-4 bg-[#222] flex flex-col justify-between items-center cursor-pointer transition-all duration-[1.2s] hover:bg-[#9c6c8b]">
              <div className="w-full mx-0 text-start flex justify-center">
